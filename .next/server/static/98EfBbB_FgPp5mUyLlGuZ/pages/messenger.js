...
function addMessage(text, type, username, created_at, recipients) {
  return {
...
var external_socket_io_client_ = __webpack_require__(16);
...
var external_dayjs_ = __webpack_require__(9);
...
/* harmony default export */ var Message = (function (_ref) {
  ...
  }, message.type === 'text' ? message.text : external_react_default.a.createElement(link_default.a, {
...
var NavBar_NavBar = function NavBar(_ref) {
  ...
  return external_react_default.a.createElement("div", {
    id: "navbar-container"
  }, external_react_default.a.createElement("div", null, "Chatting with ", currentChat), external_react_default.a.createElement(link_default.a, {
    href: "/browser",
    prefetch: true
  ...
  }), external_react_default.a.createElement("div", null, newMessage ? 'You have a new message' : '')), external_react_default.a.createElement("div", {
    className: "dropdown"
    ...
    onClick: addConvo
  }, "Start a new conversation"), friends.slice(-5).map(function (friend, i) {
...
var external_react_drag_drop_container_ = __webpack_require__(30);

// CONCATENATED MODULE: ./components/Favorites.js
var Favorites_this = undefined;
  ...
  return external_react_default.a.createElement("div", {
    ...
    return external_react_default.a.createElement(external_react_drag_drop_container_["DragDropContainer"], {
      ...
      onDrop: function onDrop() {
        return Favorites_this.props.shareFavorite(i);
      }
...
function (_React$Component) {
  ...
  function Messenger(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleMessage", function (message) {
      ...
      _this.props.addMessage(message.text, message.username, message.type, message.created_at);
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "shareFavorite", function (arrayIdx) {
      ...
      _this.props.addMessage(message.text, message.type, message.username, message.created_at, message.recipients);
    });
  ...
  _createClass(Messenger, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        ...
        id: "chatview"
      }, external_react_default.a.createElement(components_Favorites, null), external_react_default.a.createElement(components_NavBar, {
