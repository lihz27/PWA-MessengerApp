...
function (_React$Component) {
  ...
  function Messenger(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "showTypingStatus", function (e) {
      _this.socket.emit('typing', _this.props.user.username);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (e) {
      ...
      if (_this.state.text !== '') {
        ...
        _this.props.addMessage(_this.state.text, _this.props.user.username, message.created_at);
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement("div", {
        ...
        return external_react_default.a.createElement(Message, {
          key: i,
          message: message,
          username: _this4.props.user.username,
